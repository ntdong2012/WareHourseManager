...
class CoKhiViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let item4 = ItemObj(name: "Nhập BTP công đoạn",imageId: "_04", apiCode: "02", apiType: "IR", apiSP: "SP")
        let item5 = ItemObj(name: "Xuất BTP công đoạn",imageId: "_05", apiCode: "04", apiType: "DC", apiSP: "SP")
        let item6 = ItemObj(name: "Nhập chốt ca",imageId: "_06", apiCode: "03", apiType: "IR", apiSP: "SP")
        let item7 = ItemObj(name: "Nhập TP hoàn thiện",imageId: "_07", apiCode: "04", apiType: "IR", apiSP: "SP")
        let item8 = ItemObj(name: "Xuất NVL sản xuất",imageId: "_08", apiCode: "51", apiType: "IS", apiSP: "NVL")
        let item9 = ItemObj(name: "Nhập TP mạ kẽm",imageId: "_09", apiCode: "14", apiType: "IR", apiSP: "SP")
        let item10 = ItemObj(name: "Xuất TP cơ khí",imageId: "_10", apiCode: "52", apiType: "IS", apiSP: "SP")
