...
class DongKienViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let item5 = ItemObj(name: "Nhập TP mạ kẽm",imageId: "_05", apiCode: "14", apiType: "IR", apiSP: "SP")
        let item6 = ItemObj(name: "Nhập TP hoàn thiên",imageId: "_06", apiCode: "19", apiType: "IR", apiSP: "SP")
        let item7 = ItemObj(name: "Xuất NVL sản xuất",imageId: "_07", apiCode: "71", apiType: "IS", apiSP: "NVL")
